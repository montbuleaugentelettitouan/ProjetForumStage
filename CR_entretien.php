                ...
                <div class="card mb-4">
                    ...
                    <div class="cart-body">
                        ...
                        <table class="table table-bordered">
                            ...
                            $req = $bdd->prepare('select idOf, nomOf, entreprise, CR_entretien from suivi_forum join choix_offre on suivi_forum.idU = choix_offre.idUtilisateur join offres_stages on choix_offre.idOffre = offres_stages.idOf where choix_offre.idUtilisateur=?');
