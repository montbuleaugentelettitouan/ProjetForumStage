            ...
            <div class="container">
                <div class="row justify-content-center">
                    <div class="col-lg-7">
                        ...
                        <?php
                        echo "<p style='color:green'>Votre mot de passe a bien été modifié <br> Vous allez être redirigés vers votre dashboard</p>";
                        ...
                        if ($_SESSION['statut'] == 'administrateur') {
                            ...
                            ?>
                            <button type="button" class="btn btn-outline-danger"
                                    onclick=window.location.href='dashboardM1.php';>
                                Retour au menu
                            </button>
                            <?php
                        }
