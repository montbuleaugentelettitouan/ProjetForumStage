...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-red">
    <!-- Navbar Brand-->
    <a class="navbar-brand ps-3" href="nombres_postulations_offres.php">GPhy Promo <?php echo $_SESSION['promo'] ?></a>
    <!-- Sidebar Toggle-->
    ...
    if(isset($_POST['annee'])) {
        $_SESSION['compt']= 0;
        $_SESSION['annee'] = (int)$_POST['annee'];
        $_SESSION['promo'] = (int)$_POST['annee'] +1;
    ...
    ?>
    <!-- Navbar Search-->
    <form class="d-none d-md-inline-block form-inline ms-auto me-0 me-md-3 my-2 my-md-0" action="recherche.php" method="POST">
